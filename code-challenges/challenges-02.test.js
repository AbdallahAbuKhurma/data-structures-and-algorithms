...
const raisedToTheThird = (arr) => {
  ...
  const numArray = [];
  arr.forEach(element => {
    numArray.push(Math.pow(element, 3));
  });
  return numArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  const numArray = arr.map(number => number+1);
  return numArray;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const questionMark = '?';
  const stringsArray = arr.map(element => element + questionMark );
  return stringsArray;
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let index = 0 ; index < arr.length ; index++){
    numArray.push(Math.pow(2, arr[index]));
  }
  return numArray;
};
...
const forEachTwoToThe = (arr) => {
  ...
  const numArray = [];
  arr.forEach(element =>{
    numArray.push(Math.pow(2, element));
  });
  return numArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const numArray = arr.map(element => {
