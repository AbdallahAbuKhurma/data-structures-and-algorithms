...
CHALLENGE 1 - Review
 ...
 a function called addTwo that takes in an array and adds two to every value using a for loop. Place the new value in Writea new array. Return the new array.
------------------------------------------------------------------------------------------------ */
...
const typeNum = (arr) => {
  ...
  const numbersArr = arr.filter(num => {
...
const containsAnd = (arr) => {
  // Solution code here...
  const stringArr = arr.filter(element => {
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const numArr = arr.filter(element => {
