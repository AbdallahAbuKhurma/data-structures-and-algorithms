...
------------------------------------------------------------------------------------------------ */
const standardizePhoneNumbers = (arr) => arr.map(result => result.substring(1, 4) + result.substring(6, 9) + result.substring(10, 14));
...
------------------------------------------------------------------------------------------------ */
const onlyOddChars = (str) => str.split('').reduce((acc, val, idx) => (idx % 2 !== 0) ? acc += val : acc, '');
...
------------------------------------------------------------------------------------------------ */
const allHappy = (arr) => ((arr.filter(result => !(result.includes(':)'))).length > 0) ? false : true);
